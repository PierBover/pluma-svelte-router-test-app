...
var app = (function () {
    ...
    /* node_modules/pluma-svelte-router/src/Route.svelte generated by Svelte v3.37.0 */
    ...
    /* node_modules/pluma-svelte-router/src/Router.svelte generated by Svelte v3.37.0 */
    ...
    /* node_modules/pluma-svelte-router/src/Link.svelte generated by Svelte v3.37.0 */
    const file$a = "node_modules/pluma-svelte-router/src/Link.svelte";
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "class", /*cssClasses*/ ctx[3]);
    			attr_dev(a, "role", /*role*/ ctx[0]);
    			attr_dev(a, "id", /*id*/ ctx[1]);
    			add_location(a, file$a, 31, 0, 682);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(a, "click", prevent_default(/*onClick*/ ctx[4]), false, true, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    ...
    function instance$a($$self, $$props, $$invalidate) {
    	...
    	component_subscribe($$self, currentPath, $$value => $$invalidate(10, $currentPath = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	...
    	const writable_props = ["path", "activeClass", "resetScroll", "scrollToId", "role", "id", "class"];
    	...
    	$$self.$$set = $$props => {
    		...
    		if ("resetScroll" in $$props) $$invalidate(7, resetScroll = $$props.resetScroll);
    		if ("scrollToId" in $$props) $$invalidate(8, scrollToId = $$props.scrollToId);
    		if ("role" in $$props) $$invalidate(0, role = $$props.role);
    		if ("id" in $$props) $$invalidate(1, id = $$props.id);
    		if ("class" in $$props) $$invalidate(9, classes = $$props.class);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*path, href, $currentPath, classes, activeClass*/ 1636) {
    			{
    				$$invalidate(2, href = path);
    				if (href.charAt(0) !== "/" && !href.startsWith("#/")) $$invalidate(2, href = "/" + href);
    				if (href.charAt(0) !== "#") $$invalidate(2, href = "#" + href);
    				const isActive = $currentPath === path || path !== "/" && $currentPath.startsWith(path);
    				if (isActive) $$invalidate(3, cssClasses = classes ? classes + " " + activeClass : activeClass); else $$invalidate(3, cssClasses = classes);
    			}
    		}
    	};
    ...
    class Link extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*scrollToId*/ ctx[8] === undefined && !("scrollToId" in props)) {
    		...
    		if (/*classes*/ ctx[9] === undefined && !("class" in props)) {
